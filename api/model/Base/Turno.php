...
/**
 * Base class that represents a row from the 'turno' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class Turno implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\TurnoTableMap';
    ...
    /**
     * The value for the idturno field.
     *
     * @var        int
     */
    protected $idturno;
    ...
    /**
     * Initializes internal state of Base\Turno object.
     */
    ...
    /**
     * Compares this with another <code>Turno</code> instance.  If
     * <code>obj</code> is an instance of <code>Turno</code>, delegates to
     * <code>equals(Turno)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Turno The current object, for fluid interface
     */
    ...
    /**
     * Set the value of [idturno] column.
     *
     * @param int $v new value
     * @return $this|\Turno The current object (for fluent API support)
     */
    public function setIdturno($v)
    {
        ...
        if ($this->idturno !== $v) {
            $this->idturno = $v;
            $this->modifiedColumns[TurnoTableMap::COL_IDTURNO] = true;
        }
    ...
    public function setNome($v)
    {
        ...
        if ($this->nome !== $v) {
            $this->nome = $v;
            $this->modifiedColumns[TurnoTableMap::COL_NOME] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->created_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[TurnoTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($this->updated_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->updated_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[TurnoTableMap::COL_UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function setDeletedAt($v)
    {
        ...
        if ($this->deleted_at !== null || $dt !== null) {
            if ($this->deleted_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->deleted_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[TurnoTableMap::COL_DELETED_AT] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : TurnoTableMap::translateFieldName('Idturno', TableMap::TYPE_PHPNAME, $indexType)];
            $this->idturno = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : TurnoTableMap::translateFieldName('Nome', TableMap::TYPE_PHPNAME, $indexType)];
            $this->nome = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : TurnoTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : TurnoTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->updated_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : TurnoTableMap::translateFieldName('DeletedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 5; // 5 = TurnoTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Turno'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildTurnoQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildTurnoQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                TurnoTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->alunosScheduledForDeletion !== null) {
                if (!$this->alunosScheduledForDeletion->isEmpty()) {
                    \AlunoQuery::create()
                        ->filterByPrimaryKeys($this->alunosScheduledForDeletion->getPrimaryKeys(false))
                        ->delete($con);
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[TurnoTableMap::COL_IDTURNO] = true;
        if (null !== $this->idturno) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . TurnoTableMap::COL_IDTURNO . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(TurnoTableMap::COL_IDTURNO)) {
            $modifiedColumns[':p' . $index++]  = 'idturno';
        }
        if ($this->isColumnModified(TurnoTableMap::COL_NOME)) {
            $modifiedColumns[':p' . $index++]  = 'nome';
        }
        if ($this->isColumnModified(TurnoTableMap::COL_CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'created_at';
        }
        if ($this->isColumnModified(TurnoTableMap::COL_UPDATED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'updated_at';
        }
        if ($this->isColumnModified(TurnoTableMap::COL_DELETED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'deleted_at';
        }

        $sql = sprintf(
            'INSERT INTO turno (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'idturno':
                        $stmt->bindValue($identifier, $this->idturno, PDO::PARAM_INT);
                        break;
                    case 'nome':
    ...
    {
        $pos = TurnoTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Turno'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Turno'][$this->hashCode()] = true;
        $keys = TurnoTableMap::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TurnoTableMap::COL_IDTURNO)) {
            $criteria->add(TurnoTableMap::COL_IDTURNO, $this->idturno);
        }
        if ($this->isColumnModified(TurnoTableMap::COL_NOME)) {
            $criteria->add(TurnoTableMap::COL_NOME, $this->nome);
        }
        if ($this->isColumnModified(TurnoTableMap::COL_CREATED_AT)) {
            $criteria->add(TurnoTableMap::COL_CREATED_AT, $this->created_at);
        }
        if ($this->isColumnModified(TurnoTableMap::COL_UPDATED_AT)) {
            $criteria->add(TurnoTableMap::COL_UPDATED_AT, $this->updated_at);
        }
        if ($this->isColumnModified(TurnoTableMap::COL_DELETED_AT)) {
            $criteria->add(TurnoTableMap::COL_DELETED_AT, $this->deleted_at);
        }
    ...
    {
        $criteria = ChildTurnoQuery::create();
        $criteria->add(TurnoTableMap::COL_IDTURNO, $this->idturno);
    ...
    /**
     * Generic method to set the primary key (idturno column).
     *
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Turno (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Turno Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildTurno is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildTurno The current object (for fluent API support)
     */
    ...
    public function removeAluno(ChildAluno $aluno)
    {
        if ($this->getAlunos()->contains($aluno)) {
            ...
            $this->alunosScheduledForDeletion[]= clone $aluno;
            $aluno->setTurno(null);
        }
    ...
    {
        return (string) $this->exportTo(TurnoTableMap::DEFAULT_STRING_FORMAT);
    }
